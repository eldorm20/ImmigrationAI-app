...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans text-slate-900 dark:text-slate-100 bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* Trust & Payment Partners Section */}
      <div className="w-full border-y border-slate-100 dark:border-white/5 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm overflow-hidden py-10 relative z-20">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px] text-center md:text-left">
            Trusted Payment Infrastructure
          </div>
          <div className="flex items-center gap-10 md:gap-20 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
            <img src="/payment_logos_v2_1767702166046.png" alt="Stripe, Payme, Click" className="h-10 md:h-14 object-contain" />
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: "The free plan includes eligibility assessment and basic resources. Pro plan (375,000 UZS/month) includes unlimited document generation, priority chat support, and case tracking. See pricing page for details."
              },
              {
