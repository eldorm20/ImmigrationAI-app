...
export default function SettingsPage() {
  ...
  const { t, lang, setLang, script, setScript } = useI18n();
            ...
            {activeSection === 'preferences' && (
              <AnimatedCard>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {['en', 'uz', 'ru'].map((l) => (
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-bold capitalize transition-all ${lang === l
                  ...
                  {/* Script Selector (Uzbek only) */}
                  {lang === 'uz' && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}>
                      <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3">Yozuv (Script)</label>
                      <div className="flex gap-3">
                        <button
                          onClick={() => setScript('latin')}
                          className={`px-4 py-2 rounded-lg font-bold transition-all ${script === 'latin'
                            ? 'bg-brand-600 text-white'
                            : 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-bold transition-all ${script === 'cyrillic'
                            ? 'bg-brand-600 text-white'
                            : 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white'
                            }`}
                        >
                  ...
                  <div>
                    <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-3">{t.settings.fontSize}</label>
                    <div className="flex gap-3">
