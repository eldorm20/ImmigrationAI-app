        ...
        const html = `
            ...
            <body>
                ...
                <div class="totals-box">
                    <div class="total-row">
                        <span>Subtotal:</span>
                        <span>${Number(invoice.amount).toLocaleString()} UZS</span>
                    </div>
                            ...
                            <div className="flex justify-end items-center gap-6 mt-12 border-t border-slate-100 dark:border-slate-800 pt-8">
                                <div className="text-right">
                                    ...
                                    <p className="text-3xl font-black text-slate-900 dark:text-white">
                                        {newInvoice.items.reduce((sum, item) => sum + item.amount, 0).toLocaleString()} UZS
                                    </p>
                                </div>
                                ...
                                {loading ? (
                                    ...
                                    invoices.map((inv, idx) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-8 py-6">
                                                <span className="text-lg font-black text-slate-900 dark:text-white tabular-nums">{Number(inv.amount).toLocaleString()} UZS</span>
                                            </td>
                                            <td className="px-8 py-6">
