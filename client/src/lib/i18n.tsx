...
const TRANSLATIONS = {
  ...
  ru: {
    ...
    auth: { lawyerAccess: "Вход юриста", applicantLogin: "Вход заявителя", enterDetails: "Введите данные.", email: "Email", password: "Пароль", minChars: "Мин 8 символов", signIn: "Войти", noAccount: "Нет аккаунта?", register: "Регистрация", back: "Назад", firstName: "Имя", lastName: "Фамилия", emailRequired: "Email требуется", passwordRequired: "Пароль требуется", passwordTooShort: "Пароль короткий", invalidEmail: "Неверный email" },
