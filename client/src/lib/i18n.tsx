...
const TRANSLATIONS = {
  ...
  en: {
    ...
    dash: { welcome: "Welcome,", roadmap: "Roadmap", docs: "AI Docs", lawyer: "Ask Lawyer", chat: "AI Chat", logout: "Log Out", upload: "Documents", translate: "Translation", research: "Research", messages: "Messages", gov: "Gov Checks", trainer: "Interview Prep" },
  ...
  ru: {
    ...
    dash: { welcome: "Привет,", roadmap: "План", docs: "Документы", lawyer: "Юрист", chat: "Чат", logout: "Выход", upload: "Документы", translate: "Перевод", research: "Исследования", messages: "Сообщения", gov: "Гос. Проверки", trainer: "Подготовка к интервью" },
