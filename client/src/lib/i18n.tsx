...
const TRANSLATIONS = {
  ...
  ru: {
    ...
    dash: { welcome: "Привет,", roadmap: "План", docs: "Документы", lawyer: "Юрист", chat: "Чат", logout: "Выход", upload: "Документы", translate: "Перевод", research: "Исследования", messages: "Сообщения", gov: "Гос. Проверки", trainer: "Подготовка к интервью", voiceAssistant: "AI Голосовой Коуч", simulator: "Симулятор Визы", templates: "Шаблоны", agency: "Команда Агентства" },
