...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    // next steps
    "next.default.1": "Review your checklist to ensure all basic requirements are met.",
    "next.default.2": "Upload your identity documents to begin the document audit.",
    "next.default.3": "Complete the initial profile assessment in the roadmap.",
    "next.pending_docs.1": "Check the list of requested documents from your lawyer.",
    "next.pending_docs.2": "Scan and upload any missing items immediately.",
    "next.pending_docs.3": "Notify your legal team once all documents are uploaded.",
    "next.review.1": "Wait while our expert lawyers perform a detailed compliance check.",
    "next.review.2": "Monitor your inbox for any specific legal queries.",
    "next.review.3": "Consult the AI Assistant if you have questions about the review status.",
    "next.submitted_to_gov.1": "Prepare for your biometric appointment if required.",
    "next.submitted_to_gov.2": "Track the official case status using your reference number.",
    "next.submitted_to_gov.3": "Practice for your potential interview with our AI Coach.",
  ...
  uz: {
    ...
    "dash.chat": "AI Yordamchi",
    "dash.messages": "Xabarlar",
    "dash.lawyer": "Konsultatsiya",
    "dash.research": "Tadqiqot",
    ...
    "dashStatus.under_review_desc": "Hozirda mutaxassis yuristlar hujjatlaringizni so'nggi immigratsiya qoidalariga muvofiqligini tekshirmoqda.",
    "dashStatus.pending_docs_desc": "Yuristlarimiz sizning ishingizni yakunlashi uchun yana bir nechta hujjatlar kerak.",
    ...
    // next steps
    "next.default.1": "Barcha asosiy talablar bajarilganligini tekshirish uchun nazorat ro'yxatini ko'rib chiqing.",
    "next.default.2": "Hujjatlar auditini boshlash uchun shaxsingizni tasdiqlovchi hujjatlarni yuklang.",
    "next.default.3": "Yo'l xaritasidagi dastlabki profil baholashni yakunlang.",
    "next.pending_docs.1": "Yuristingizdan so'ralgan hujjatlar ro'yxatini tekshiring.",
    "next.pending_docs.2": "Barcha etishmayotgan hujjatlarni darhol skanerlang va yuklang.",
    "next.pending_docs.3": "Barcha hujjatlar yuklangandan so'ng yuridik guruhni xabardor qiling.",
    "next.review.1": "Ekspert yuristlarimiz batafsil muvofiqlik tekshiruvini o'tkazishini kuting.",
    "next.review.2": "Elektron pochtangizni maxsus yuridik so'rovlar uchun kuzatib boring.",
    "next.review.3": "Ko'rib chiqish holati haqida savollaringiz bo'lsa, AI yordamchisiga murojaat qiling.",
    "next.submitted_to_gov.1": "Agar kerak bo'lsa, biometrik ma'lumotlarni topshirishga tayyorlaning.",
    "next.submitted_to_gov.2": "Malumot raqamingizdan foydalanib rasmiy ish holatini kuzatib boring.",
    "next.submitted_to_gov.3": "AI Coach bilan potentsial intervyuga tayyorlaning.",
  },
  ru: {
    // nav
    "nav.home": "Главная",
    ...
    // dashStatus
    "dashStatus.journey": "Прогресс путешествия",
    "dashStatus.submitted_to_gov": "Официальная подача в госорганы",
    "dashStatus.under_review": "На юридической проверке",
    "dashStatus.pending_documents": "Требуются документы",
    "dashStatus.case_prep": "Подготовка дела",
    "dashStatus.final_decision": "Окончательное решение",
    "dashStatus.prep_desc": "Вы находитесь на ранних стадиях вашего иммиграционного пути. Следуйте дорожной карте, чтобы завершить подачу.",
    "dashStatus.under_review_desc": "Эксперты-юристы в настоящее время сверяют ваши документы с последними иммиграционными правилами.",
    "dashStatus.pending_docs_desc": "Нам нужно еще несколько элементов, прежде чем наши юристы смогут финализировать подачу вашего дела.",
    "dashStatus.submitted_gov_desc": "Ваша заявка была официально подана в государственные органы. Наша юридическая команда подтвердила все детали.",

    // next steps
    "next.default.1": "Просмотрите контрольный список, чтобы убедиться, что все основные требования соблюдены.",
    "next.default.2": "Загрузите документы, удостоверяющие личность, чтобы начать аудит документов.",
    "next.default.3": "Завершите начальную оценку профиля в дорожной карте.",
    "next.pending_docs.1": "Проверьте список запрошенных документов от вашего юриста.",
    "next.pending_docs.2": "Немедленно отсканируйте и загрузите все недостающие элементы.",
    "next.pending_docs.3": "Уведомите свою юридическую команду, как только все документы будут загружены.",
    "next.review.1": "Подождите, пока наши эксперты-юристы проведут подробную проверку на соответствие.",
    "next.review.2": "Следите за своим почтовым ящиком на предмет конкретных юридических запросов.",
    "next.review.3": "Проконсультируйтесь с ИИ-ассистентом, если у вас есть вопросы о статусе проверки.",
    "next.submitted_to_gov.1": "Подготовьтесь к приему биометрических данных, если это необходимо.",
    "next.submitted_to_gov.2": "Отслеживайте официальный статус дела, используя свой справочный номер.",
    "next.submitted_to_gov.3": "Практикуйтесь для возможного интервью с нашим ИИ-тренером.",
  },
};
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = useMemo(() => {
    ...
    (fn as any).dash = {
      ...
      chat: dict["dash.chat"] || "AI Assistant",
