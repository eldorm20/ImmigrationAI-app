...
const TRANSLATIONS = {
  en: {
        ...
        consultation: {
              missingInfo: "Please select a lawyer and scheduled time",
              requestSubmitted: "Consultation request submitted! The lawyer will confirm shortly.",
              submitError: "Failed to submit consultation request",
              cancelled: "Consultation cancelled",
              cancelError: "Failed to cancel consultation",
              consultationChat: "Consultation Chat",
              joinVideoCall: "Join Video Meeting",
              title: "Consultations",
              ...
              setMeetingLinkTitle: "Confirm and Set Meeting Link",
  ...
  uz: {
            ...
            consultation: {
              missingInfo: "Iltimos, yurist va vaqtni tanlang",
              requestSubmitted: "Konsultatsiya so'rovi yuborildi! Yurist tez orada tasdiqlaydi.",
              submitError: "Konsultatsiya so'rovini yuborib bo'lmadi",
              cancelled: "Konsultatsiya bekor qilindi",
              cancelError: "Konsultatsiyani bekor qilib bo'lmadi",
              consultationChat: "Konsultatsiya Chat",
              joinVideoCall: "Video Uchrashuvga Qo'shiling",
              title: "Konsultatsiyalar",
              acceptAndConfirm: "Qabul qiling va tasdiqlang",
              reject: "Bekor qilish",
              confirm: "Tasdiqlash",
              cancel: "Bekor qilish",
              completedLabel: "✓ Tugallandi",
              cancelledLabel: "✗ Bekor qilindi",
              requestedDate: "So'ralgan sana",
              timeDuration: "Vaqt va Davomiylik",
              applicantNotes: "Arizachi Izohlari",
              meetingLinkLabel: "Uchrashuv Havolasi",
              setMeetingLinkTitle: "Uchrashuv Havolasini Tasdiqlash va Sozlash",
              meetingLinkPlaceholder: "https://meet.google.com/...",
              internalNotes: "Ichki Eslatmalar (ixtiyoriy)",
  ...
  ru: {
            ...
            consultation: {
              missingInfo: "Пожалуйста, выберите юриста и время консультации",
              requestSubmitted: "Запрос на консультацию отправлен! Юрист скоро подтвердит.",
              submitError: "Не удалось отправить запрос на консультацию",
              cancelled: "Консультация отменена",
              cancelError: "Не удалось отменить консультацию",
              consultationChat: "Чат консультации",
              joinVideoCall: "Присоединиться к видеовстрече",
              title: "Консультации",
              ...
              applicantNotes: "Заметки заявителя",
              meetingLinkLabel: "Ссылка на встречу",
              setMeetingLinkTitle: "Подтвердить и установить ссылку на встречу",
              meetingLinkPlaceholder: "https://meet.google.com/...",
              internalNotes: "Внутренние заметки (необязательно)",
  ...
  de: {
            ...
            consultation: {
              missingInfo: "Bitte wählen Sie einen Anwalt und eine Zeit aus",
              requestSubmitted: "Beratungsanfrage gesendet! Der Anwalt bestätigt in Kürze.",
              submitError: "Beratungsanfrage konnte nicht gesendet werden",
              cancelled: "Beratung storniert",
              cancelError: "Beratung konnte nicht storniert werden",
              consultationChat: "Beratungs-Chat",
              joinVideoCall: "Video-Meeting beitreten",
              title: "Beratungen",
              acceptAndConfirm: "Akzeptieren & Bestätigen",
              reject: "Ablehnen",
              confirm: "Bestätigen",
              cancel: "Abbrechen",
              ...
              applicantNotes: "Notizen des Antragstellers",
              meetingLinkLabel: "Meeting-Link",
              setMeetingLinkTitle: "Meeting-Link bestätigen und setzen",
              meetingLinkPlaceholder: "https://meet.google.com/...",
  ...
  fr: {
            ...
            consultation: {
              missingInfo: "Veuillez sélectionner un avocat et une date",
              requestSubmitted: "Demande de consultation envoyée ! L'avocat confirmera sous peu.",
              submitError: "Échec de l'envoi de la demande de consultation",
              cancelled: "Consultation annulée",
              cancelError: "Échec de l'annulation de la consultation",
              consultationChat: "Chat de consultation",
              joinVideoCall: "Rejoindre la réunion vidéo",
              title: "Consultations",
              ...
              applicantNotes: "Notes du demandeur",
              meetingLinkLabel: "Lien de réunion",
              setMeetingLinkTitle: "Confirmer et définir le lien de réunion",
              meetingLinkPlaceholder: "https://meet.google.com/...",
              internalNotes: "Notes internes (optionnel)",
              notesPlaceholder: "Toutes notes supplémentaires...",
            },
        common: {
          connected: "Connecté",
  ...
  es: {
            ...
            consultation: {
              missingInfo: "Por favor selecciona un abogado y la hora",
              requestSubmitted: "¡Solicitud de consulta enviada! El abogado confirmará en breve.",
              submitError: "No se pudo enviar la solicitud de consulta",
              cancelled: "Consulta cancelada",
              cancelError: "No se pudo cancelar la consulta",
              consultationChat: "Chat de Consulta",
              joinVideoCall: "Unirse a Videoconferencia",
              title: "Consultas",
              acceptAndConfirm: "Aceptar y confirmar",
              reject: "Rechazar",
              confirm: "Confirmar",
              cancel: "Cancelar",
              ...
              setMeetingLinkTitle: "Confirmar y establecer enlace de la reunión",
              meetingLinkPlaceholder: "https://meet.google.com/...",
