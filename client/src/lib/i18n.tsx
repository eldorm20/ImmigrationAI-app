...
type Language = "en" | "uz" | "ru" | "de" | "fr" | "es" | "ar" | "zh";
...
const TRANSLATIONS = {
  uz: {
    ...
    consultation: { title: "Maslahatlar", requestConsultation: "Maslahat So'rash", selectLawyer: "Yuristni Tanlang", preferredDateTime: "Afzal Sana va Vaqt", duration: "Davomiylik (daqiqa)", notes: "Eslatmalar", submitRequest: "Jo'natish", cancel: "Bekor Qilish", joinVideoCall: "Video Chaqiruvga Qo'shilish", consultationChat: "Chat", noConsultations: "Maslahatlar yo'q", availableLawyers: "Mavjud Yuristlar", requestSubmitted: "So'rov jo'natildi", lawyerWillReview: "Yurist ko'rib chiqadi", newRequest: "Yangi So'rov", from: "dan", requestedTime: "So'ralgan Vaqt", status: "Holat", scheduled: "Rejalashtirilgan", completed: "Tugallandi", cancelled: "Bekor Qilindi", noShow: "Kelishmadi" },
  ...
  ru: {
    ...
    tools: { gen: "Создать", dl: "Скачать", typing: "Пишет...", chatP: "Спросить о визе...", clear: "Очистить" },
    ...
    consultation: { title: "Консультации", requestConsultation: "Запросить", selectLawyer: "Выбрать юриста", preferredDateTime: "Дата и время", duration: "Продолжительность (минуты)", notes: "Заметки", submitRequest: "Отправить", cancel: "Отмена", joinVideoCall: "Присоединиться", consultationChat: "Чат", noConsultations: "Нет консультаций", availableLawyers: "Доступные", requestSubmitted: "Отправлено", lawyerWillReview: "Юрист рассмотрит", newRequest: "Новый запрос", from: "от", requestedTime: "Время", status: "Статус", scheduled: "Запланировано", completed: "Завершено", cancelled: "Отменено", noShow: "Не пришел" },
...
>>>>>>> 0f9bbc7 (Complete: All critical features fixed, i18n rebuilt, real-time messaging, lawyer dashboard, consultations fully implemented and integrated.)
