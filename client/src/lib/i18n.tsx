...
const TRANSLATIONS = {
  uz: {
    ...
    dash: { welcome: "Xush kelibsiz,", roadmap: "Reja", docs: "AI Hujjatlar", lawyer: "Yurist", chat: "AI Chat", logout: "Chiqish", upload: "Hujjatlar", translate: "Tarjima", research: "Tadqiqot", messages: "Xabarlar", employerVerification: "Ish beruvchi tekshiruvi", applications: "Arizalar", tabSwitched: "Tab almashtirildi", overview: "Umumiy ko'rinish", gov: "Gov Tekshiruvlari", trainer: "Intervyu tayyorgarligi", simulator: "Viza Simulyatori", templates: "Andozalar", agency: "Agentlik Jamoasi" },
  ...
  en: {
    ...
    dash: { welcome: "Welcome,", roadmap: "Roadmap", docs: "AI Docs", lawyer: "Ask Lawyer", chat: "AI Chat", logout: "Log Out", upload: "Documents", translate: "Translation", research: "Research", messages: "Messages", gov: "Gov Checks", trainer: "Interview Prep", simulator: "Visa Simulator", templates: "Templates", agency: "Agency Team" },
  ...
  ru: {
    ...
    dash: { welcome: "Привет,", roadmap: "План", docs: "Документы", lawyer: "Юрист", chat: "Чат", logout: "Выход", upload: "Документы", translate: "Перевод", research: "Исследования", messages: "Сообщения", gov: "Гос. Проверки", trainer: "Подготовка к интервью", simulator: "Симулятор Визы", templates: "Шаблоны", agency: "Команда Агентства" },
