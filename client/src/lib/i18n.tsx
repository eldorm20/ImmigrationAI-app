...
const TRANSLATIONS = {
  uz: {
    ...
    common: { success: "Muvaffaq", error: "Xato", connected: "Ulangan", disconnected: "Uzilgan", date: "Sana", page: "Sahifa", of: "dan", previous: "Oldingisi", next: "Keyingi", view: "Ko'rish", actions: "Harakatlar" },
    ...
    consultation: {
      ...
      cancelError: "Bekor qilishda xato.",
       // cancelled: "Bekor Qilindi", // Removed duplicate key
    },
    ...
    lawyerDashboard: { title: "Yurist Paneli", applications: "Arizalar", consultations: "Maslahatlar", status: "Holat", rev: "To'lov" },
